<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!DOCTYPE html>      
 <div id="DaumNewsdataExport">   
   <div class="modal fade" id="dataExportDaumNewsRequestPopup" tabindex="-1" role="dialog" aria-labelledby="examquestion_plusLabel" aria-hidden="true">
            ...
            <div class="modal-body">
               <div class="wsize_30 po_r bd_d05 table_sc03" id="style-3">
                  <div class="modal-header bg_blue font_w">
                  	 <div >
                     	<h5 class="modal-title fw_5 f_sq " id="examquestion_plusLabel">| 데이터 반출 요청 목록 - 다음  뉴스 데이터 - </h5>
                     </div>	
                  </div>
                  <div>
                  	<table class="table table-gray table-hover" >
                  		<tr v-for="(DaumRequestList, index) in selectApprovalDaumRequestList" v-on:click="exportInfo(DaumRequestList.dataExportRequestCode, index)">
							<td class="bold color_b">
								<a>데이터 셋 : {{DaumRequestList.datasetName}} <bold>|</bold> 요청키워드 : {{DaumRequestList.exportCollectWord}}<font :id="'exportButton'+index">▼</font></a>
                ...
                <div class="wsize_30  po_r bd_d05 table_sc03" id="style-3">
                  ...
                  <div class="po_r mt_60" id="style-3">
                  	 ...
                  	 <div>
                  	 	<table class="mg_auto ta_center" cellpadding="8">
                  	 		<tr>
                  	 			<td> 크론표현식 : </td>
                  	 			<td>
		                  	 		<select class="form-control" id="exportDaumCron">
										<option>작업선택</option>
										<option>일시적지정</option>
									  	<option>증분지정</option>
									</select>
                     ...
                     <table class="mg_auto ta_center" cellpadding="8" id="dataExportDaumDirect">
                        <tr>
						   ...
						   <td class="direct ">
						   		...
						   		<select class="form-control seconds " id="dataExportDaumSeconds" style="width:115px; text-align-last:center; " v-model="seconds">
									<option> - </option>
									<option>직접입력</option>
						   		</select>
						   </td>
                        ...
                        <tr>
                           ...
                           <td class="direct">
						   		...
						   		<select class="form-control minutes" id="dataExportDaumMinutes" style="width:115px; text-align-last:center;" v-model="minutes">
									<option>-</option>
									<option>직접입력</option>
						   		</select>
                        ...
                        <tr>
                           ...
                           <td class="direct">
						   		...
						   		<select class="form-control hours" id="dataExporDaumHours" style="width:115px; text-align-last:center;" v-model="hours">
									<option>-</option>
									<option>직접입력</option>
						   		</select>
						   </td>
                        ...
                        <tr>
                           ...
                           <td class="direct">
						   		...
						   		<select class="form-control day" id="dataExportDaumDay" style="width:115px; text-align-last:center;" v-model="day">
									<option>-</option>
									<option>직접입력</option>
						   		</select>
						   </td>
                        ...
                        <tr>
                           ...
                           <td class="direct">
						   		...
						   		<select class="form-control months" id="dataExportDaumMonths" style="width:115px; text-align-last:center;" v-model="month">
									<option>-</option>
									<option>직접입력</option>
						   		</select>
						   </td>
                        ...
                        <tr>
                           ...
                           <td class="direct">
						   		...
						   		<select class="form-control year" id="dataExportDaumYear" style="width:115px; text-align-last:center;" v-model="year">
									<option>-</option>
									<option>직접입력</option>
						   		</select>
						   </td>
                     ...
                     <table class="mg_auto ta_center" cellpadding="8" id="dataExportDaumEach">
                        <tr>
                           <td class="fl"> 초 (Seconds):</td>
						   
						   <td>
						   		<select class="form-control" id="dataExportDaumEachSeconds">
									<option>범위지정</option>
							  		<option>매초마다</option>
						   		</select>
						   </td>
                        ...
                        <tr>
						   ...
						   <td>
						   		<select class="form-control" id="dataExportDaumEachMinutes">
									<option>범위지정</option>
							  		<option>매분마다</option>
						   		</select>
						   </td>
                        ...
                        <tr>
						   ...
						   <td>
						   		<select class="form-control" id="dataExportDaumEachHours">
									<option>범위지정</option>
							  		<option>매시간마다</option>
						   		</select>
						   </td>
                        ...
                        <tr>
						   ...
						   <td>
						   		<select class="form-control" id="dataExportDaumEachDay" >
									<option>범위지정</option>
							  		<option>매일마다</option>
						   		</select>
						   </td>
                        ...
                        <tr>
						   ...
						   <td>
						   		<select class="form-control" id="dataExportDaumEachMonth" >
									<option>범위지정</option>
							  		<option>매월마다</option>
						   		</select>
						   </td>
...
<jsp:include page="/WEB-INF/view/admin/dataManage/script/dataExportDaumNewsRequestPopupScript.jsp"></jsp:include>
