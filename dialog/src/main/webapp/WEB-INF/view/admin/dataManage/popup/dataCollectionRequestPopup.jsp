<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!DOCTYPE html>      
 <div id="dataCollectionListd">   
   <div class="modal fade" id="dataCollectionRequestPopup" tabindex="-1" role="dialog" aria-labelledby="examquestion_plusLabel" aria-hidden="true">
            ...
            <div class="modal-body">
               <div class="wsize_30 po_r bd_d05 table_sc03" id="style-3">
                  <div class="modal-header bg_blue font_w">
                  	 <div>
                     	<h5 class="modal-title fw_5 f_sq " id="examquestion_plusLabel">| 데이터 수집 요청 목록 </h5>
                     </div>	
                  </div>
                  <div>
                  	<table class="table table-gray table-hover" >
                  		<tr v-for="(daumApprovalRequest, index) in selectApprovalDaumRequestList" >
							<td class="bold color_b">
								<a v-on:click="adad(daumApprovalRequest.daumNewsDataCollectRequestCode, index)" >{{daumApprovalRequest.daumNewsRequestCollectWord}}<font :id="'button'+index">▼</font></a>
                ...
                <div class="wsize_30  po_r bd_d05 table_sc03" id="style-3">
                  ...
                  <div class="po_r" id="style-3">
                    <div class="modal-header">
                  	...
                  	<table class="mg_auto ta_center" cellpadding="5" >
                        ...
                        <tr style="padding:10px">
                           <td class="table_tr_td_01">개발 소스 파일명 :</td><td><input type="text"  style="width:200px;  background-color: #e2e2e2;" v-model="devSourceTitle" readonly></td>
                        </tr>
                        <tr style="padding:10px">
                           <td class="table_tr_td_01">개발 소스 파일 경로 :</td><td><input type="text"  style="width:200px;  background-color: #e2e2e2;" v-model="devSourceFilePath" readonly></td>
                        </tr>
                     </table>
                  </div>
                  <div class="po_r mt_60" id="style-3">
                  	 ...
                  	 <div>
                  	 	<table class="mg_auto ta_center" cellpadding="8">
                  	 		<tr>
                  	 			<td> 크론표현식 : </td>
                  	 			<td>
		                  	 		<select class="form-control" id="cron">
										<option>작업선택</option>
										<option>일시적지정</option>
									  	<option>증분지정</option>
									</select>
                     ...
                     <table class="mg_auto ta_center" cellpadding="8" id="dataCollectDirect">
                        <tr>
						   ...
						   <td class="direct ">
						   		...
						   		<select class="form-control seconds " id="dataCollectSeconds" style="width:115px; text-align-last:center; " v-model="seconds">
									<option> - </option>
									<option>직접입력</option>
						   		</select>
						   </td>
                        ...
                        <tr>
                           ...
                           <td class="direct">
						   		...
						   		<select class="form-control minutes" id="dataCollectMinutes" style="width:115px; text-align-last:center;" v-model="minutes">
									<option>-</option>
									<option>직접입력</option>
						   		</select>
                        ...
                        <tr>
                           ...
                           <td class="direct">
						   		...
						   		<select class="form-control hours" id="dataCollectHours" style="width:115px; text-align-last:center;" v-model="hours">
									<option>-</option>
									<option>직접입력</option>
						   		</select>
						   </td>
                        ...
                        <tr>
                           ...
                           <td class="direct">
						   		...
						   		<select class="form-control day" id="dataCollectDay" style="width:115px; text-align-last:center;" v-model="day">
									<option>-</option>
									<option>직접입력</option>
						   		</select>
						   </td>
                        ...
                        <tr>
                           ...
                           <td class="direct">
						   		...
						   		<select class="form-control months" id="dataCollectMonths" style="width:115px; text-align-last:center;" v-model="month">
									<option>-</option>
									<option>직접입력</option>
						   		</select>
						   </td>
                        ...
                        <tr>
                           ...
                           <td class="direct">
						   		...
						   		<select class="form-control year" id="dataCollectYear" style="width:115px; text-align-last:center;" v-model="year">
									<option>-</option>
									<option>직접입력</option>
						   		</select>
						   </td>
                     ...
                     <table class="mg_auto ta_center" cellpadding="8" id="dataCollectEach">
                        <tr>
                           <td class="fl"> 초 (Seconds):</td>
						   
						   <td>
						   		<select class="form-control" id="dataCollectEachSeconds">
									<option>범위지정</option>
							  		<option>매초마다</option>
						   		</select>
						   </td>
                        ...
                        <tr>
						   ...
						   <td>
						   		<select class="form-control" id="dataCollectEachMinutes">
									<option>범위지정</option>
							  		<option>매분마다</option>
						   		</select>
						   </td>
                        ...
                        <tr>
						   ...
						   <td>
						   		<select class="form-control" id="dataCollectEachHours">
									<option>범위지정</option>
							  		<option>매시간마다</option>
						   		</select>
						   </td>
                        ...
                        <tr>
						   ...
						   <td>
						   		<select class="form-control" id="dataCollectEachDay" >
									<option>범위지정</option>
							  		<option>매일마다</option>
						   		</select>
						   </td>
                        ...
                        <tr>
						   ...
						   <td>
						   		<select class="form-control" id="dataCollectEachMonth" >
									<option>범위지정</option>
							  		<option>매월마다</option>
						   		</select>
						   </td>
...
<jsp:include page="/WEB-INF/view/admin/dataManage/script/dataCollectionRequestPopupScript.jsp"></jsp:include>
