...
//	                   System.out.println("INLINE_STRING 값 : "+thisStr);
	                   break;
...
//	                       System.out.println("SST_STRING 값 : "+thisStr);
	                       ...
	                       else if (excelCellRef.checkDate(thisStr,"yy년MM월")) {
	                    	   thisStr = excelCellRef.reformatDate(thisStr, "yy년MM월", "yyyy-MM-dd");
	                       }
	                       else if (excelCellRef.checkDate(thisStr,"yyyy년MM월")) {
	                    	   thisStr = excelCellRef.reformatDate(thisStr, "yyyy년MM월", "yyyy-MM-dd");
	                       }
	                       else if (excelCellRef.checkDate(thisStr,"yy년 MM월")) {
	                    	   thisStr = excelCellRef.reformatDate(thisStr, "yy년 MM월", "yyyy-MM-dd");
	                       }
	                       else if (excelCellRef.checkDate(thisStr,"yyyy년 MM월")) {
	                    	   thisStr = excelCellRef.reformatDate(thisStr, "yyyy년 MM월", "yyyy-MM-dd");
	                       }
	                       else if (excelCellRef.checkDate(thisStr,"yy년")) {
	                    	   thisStr = excelCellRef.reformatDate(thisStr, "yy년", "yyyy");
	                       }
	                       else if (excelCellRef.checkDate(thisStr,"yyyy년")) {
	                    	   thisStr = excelCellRef.reformatDate(thisStr, "yyyy년", "yyyy");
	                       }
	                   }
...
//	                	   System.out.println("NUMBER formatString null 아닐 때: "+thisStr);
//	                   }
	                   if(this.formatString != null && this.formatString.equals("yyyy-mm-dd;@")) {
	                	   ...
	                	   thisStr = n;
//	                	   System.out.println("NUMBER value 그대로: "+thisStr);
	                   }
