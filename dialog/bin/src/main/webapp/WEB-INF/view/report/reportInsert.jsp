   ...
   <div class="full_box wsize_90" id="reportInsert">
      ...
      <div>
         <form id="insertReportFrm" method="post" enctype="multipart/form-data">
            <table class="table table-ddd02" class="" >
               ...
               <tbody>
                     ...
                     <th>서비스 형태</th>
                      <td colspan="4"> 
                                <label class="custom-control custom-radio fl">
                                  <input id="radio1" name="typeNormalRegularly" type="radio" checked="checked" class="custom-control-input" value="보고서">
                                  <span class="custom-control-indicator"></span>
                                 <span class="custom-control-description">보고서</span>
                             </label>
                             <label class="custom-control custom-radio fl">
                  ...
                  <tr>
                     <th>제목</th>
                     <td colspan="4"><input type="text" class="wsize_100 form-control" maxlength="35" name="reportName" id="reportName"/></td>
                  </tr>
                  <tr>
                     <th>카테고리</th>
                     <td>1분류</td>
                  ...
                  <tr>
                     ...
                     <td colspan ="4">
                        ...
                        <div class="filebox bs3-primary" style="display:none;">
                           <div class="upload-name fl" v-for="(dataListCode, index) in dataBox2" v-model="dataCodeList" v-bind:value="dataListCode.dataCodeList">
                              {{dataListCode}}
                           </div>
                        </div>
                     </td>
                  ...
                  <tr>
                     <td colspan="5"><textarea class="form-control rounded-0" rows="18" maxlength="1200" name="reportInfo"></textarea></td>
                  </tr>
         ...
         <div class="buttons mt_15" role="group" aria-label="...">
            ...
            <a href="/report/reportList"class="btn btn-cencle size_100 fr mr_5" role="button">취소</a>      
         </div>
