<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
 <div id="schInsert">   
   <div class="modal fade" id="scheduleInsertPopup" tabindex="-1" role="dialog" aria-labelledby="examquestion_plusLabel" aria-hidden="true">
      <div class="modal-dialog" role="document" style="max-width:1700px; height:800px">
         <div class="modal-content">
            ...
            <div class="modal-body">
               <div class="wsize_30 po_r bd_d05 table_sc05" id="style-3">
                  <div class="modal-header bg_blue font_w">
                  	 <div>
                     	<h5 class="modal-title fw_5 f_sq " id="examquestion_plusLabel">| 개발 소스 파일 목록 </h5>
                     </div>	
                  </div>
                  <div id="sibal">
                  	<table class="table table-gray table-hover" >
                  		<tr v-for="(developFileList, index) in DevelopSourceList" v-bind:class="{trSelect : checkDevSourceCode == developFileList.devSourceCode}">
							<td :id="'hover'+index"  class="man">
								<a v-on:click="developInfo(developFileList.devSourceCode, index)" >{{developFileList.devSourceTitle}}</font></a>
								<div :id="'tab'+index" style="display:none" >
						 			<table class="table table-board02  mt_10">
										<tr>
											<th>수집단어</td>
											<td :id="'keword'+index"></td>
										</tr>
										<tr>
											<th>요청날짜</td>
											<td :id="'requestdate'+index"></td>
										</tr>
										<tr>
											<th>수집기간</td>
											<td :id="'collectdate'+index"></td>
										</tr>
									</table>
								</div>
							</td>
                ...
                <div class="wsize_30  po_r bd_d05 table_sc05" id="style-3">
                  ...
                  <div class="po_r" id="style-3">
                    <div class="modal-header">
                     	 <div class="mg_auto">
                    	 	<h5 class="modal_tile_01 fw_5 f_sq"  >개발 소스 파일 정보</h5>
                    	 </div>
                  	</div>
                  	<table class="mg_auto ta_center" cellpadding="5" >
                        <tr style="padding:10px">
                           <td class="table_tr_td_01">작업명 :</td><td><input type="text" style="width:200px; background-color: #e2e2e2;" v-model="devSourceFileInfo.devSourceTitle" readonly></td>
                        </tr>
                        <tr style="padding:10px">
                           <td class="table_tr_td_01">개발 소스 파일명 :</td><td><input type="text"  style="width:200px; background-color: #e2e2e2;"  v-model="devSourceFileInfo.devSourceFileTitle" readonly></td>
                        </tr>
                        <tr style="padding:10px">
                           <td class="table_tr_td_01">개발 소스 파일 경로 :</td><td><input type="text"  style="width:200px; background-color: #e2e2e2;"  v-model="devSourceFileInfo.devSourcefileRoute" readonly></td>
                        </tr>
                     </table>
                  </div>
                  <div class="po_r mt_60" id="style-3">
                  	 ...
                  	 <div>
                  	 	<table class="mg_auto ta_center" cellpadding="8">
                  	 		<tr>
                  	 			<td> 크론표현식 : </td>
                  	 			<td>
		                  	 		<select class="form-control" id="devCron">
										<option>작업선택</option>
										<option>일시적지정</option>
									  	<option>증분지정</option>
									</select>
                     ...
                     <table class="mg_auto ta_center" cellpadding="8" id="devDirect">
                        <tr>
						   ...
						   <td class="direct ">
						   		...
						   		<select class="form-control seconds " id="devSeconds" style="width:115px; text-align-last:center; " v-model="seconds">
									<option> - </option>
									<option>직접입력</option>
						   		</select>
						   </td>
                        ...
                        <tr>
                           ...
                           <td class="direct">
						   		...
						   		<select class="form-control minutes" id="devMinutes" style="width:115px; text-align-last:center;" v-model="minutes">
									<option>-</option>
									<option>직접입력</option>
						   		</select>
                        ...
                        <tr>
                           ...
                           <td class="direct">
						   		...
						   		<select class="form-control hours" id="devHours" style="width:115px; text-align-last:center;" v-model="hours">
									<option>-</option>
									<option>직접입력</option>
						   		</select>
						   </td>
                        ...
                        <tr>
                           ...
                           <td class="direct">
						   		...
						   		<select class="form-control day" id="devDay" style="width:115px; text-align-last:center;" v-model="day">
									<option>-</option>
									<option>직접입력</option>
						   		</select>
						   </td>
                        ...
                        <tr>
                           ...
                           <td class="direct">
						   		...
						   		<select class="form-control months" id="devMonths" style="width:115px; text-align-last:center;" v-model="month">
									<option>-</option>
									<option>직접입력</option>
						   		</select>
						   </td>
                        ...
                        <tr>
                           ...
                           <td class="direct">
						   		...
						   		<select class="form-control year" id="devYear" style="width:115px; text-align-last:center;" v-model="year">
									<option>-</option>
									<option>직접입력</option>
						   		</select>
						   </td>
                     ...
                     <table class="mg_auto ta_center" cellpadding="8" id="devEach">
                        <tr>
                           <td class="fl"> 초 (Seconds):</td>
						   
						   <td>
						   		<select class="form-control" id="devEachSeconds">
									<option>범위지정</option>
							  		<option>매초마다</option>
						   		</select>
						   </td>
                        ...
                        <tr>
						   ...
						   <td>
						   		<select class="form-control" id="devEachMinutes">
									<option>범위지정</option>
							  		<option>매분마다</option>
						   		</select>
						   </td>
                        ...
                        <tr>
						   ...
						   <td>
						   		<select class="form-control" id="devEachHours">
									<option>범위지정</option>
							  		<option>매시간마다</option>
						   		</select>
						   </td>
                        ...
                        <tr>
						   ...
						   <td>
						   		<select class="form-control" id="devEachDay" >
									<option>범위지정</option>
							  		<option>매일마다</option>
						   		</select>
						   </td>
                        ...
                        <tr>
						   ...
						   <td>
						   		<select class="form-control" id="devEachMonth" >
									<option>범위지정</option>
							  		<option>매월마다</option>
						   		</select>
						   </td>
               ...
               <div class="wsize_40  po_r bd_d05 table_sc05" id="style-3">
                  <div class="modal-header bg_blue font_w">
                     <div>
                     	<h5 class="modal_tile_01 fw_5 f_sq " id="examquestion_plusLabel">| 등록된 스케줄 목록</h5>
                     </div>	
                  </div>
                  <div>
...
<jsp:include page="/WEB-INF/view/admin/scheduleManage/script/scheduleInsertScript.jsp"></jsp:include>  
