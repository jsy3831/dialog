<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!DOCTYPE html>      
 <div id="dataExportShopping">   
   <div class="modal fade" id="dataExportRequestShoppingPopup" tabindex="-1" role="dialog" aria-labelledby="examquestion_plusLabel" aria-hidden="true">
            ...
            <div class="modal-body">
               <div class="wsize_30 po_r bd_d05 table_sc03" id="style-3">
                  <div class="modal-header bg_blue font_w">
                  	 <div>
                     	<h5 class="modal-title fw_5 f_sq " id="examquestion_plusLabel">데이터 반출 요청 목록 - 쇼핑 데이터 - </h5>
                     </div>	
                  </div>
                  <div>
                  	<table class="table table-gray table-hover" >
                  		<tr v-for="(shoppingRequest, index) in selectApprovalShopRequestLists" >
							<td class="bold color_b">
								<a v-on:click="exportInfo(shoppingRequest.dataExportRequestCode,shoppingRequest.datasetName, index)" >{{shoppingRequest.exportCollectWord}}<font :id="'exportButtonShopping'+index">▼</font></a>
								<div :id="'exportTabShopping'+index" style="display:none" >
						 			<table class="table table-board02  mt_10">
										<tr>
											<th>수집단어</td>
											<td :id="'exportKewordShopping'+index"></td>
										</tr>
										<tr>
											<th>요청날짜</td>
											<td :id="'exportRequestDateShopping'+index"></td>
										</tr>
										<tr>
											<th>수집기간</td>
											<td :id="'exportCollectionDateShopping'+index"></td>
										</tr>
									</table>
								</div>
							</td>
                ...
                <div class="wsize_30  po_r bd_d05 table_sc03" id="style-3">
                  ...
                  <div class="po_r mt_60" id="style-3">
                  	 ...
                  	 <div>
                  	 	<table class="mg_auto ta_center" cellpadding="8">
                  	 		<tr>
                  	 			<td> 크론표현식 : </td>
                  	 			<td>
		                  	 		<select class="form-control" id="exportShoppingCron">
										<option>작업선택</option>
										<option>일시적지정</option>
									  	<option>증분지정</option>
									</select>
                     ...
                     <table class="mg_auto ta_center" cellpadding="8" id="dataExportShoppingDirect">
                        <tr>
						   ...
						   <td class="direct ">
						   		...
						   		<select class="form-control seconds " id="dataExportShoppingSeconds" style="width:115px; text-align-last:center; " v-model="seconds">
									<option> - </option>
									<option>직접입력</option>
						   		</select>
						   </td>
                        ...
                        <tr>
                           ...
                           <td class="direct">
						   		...
						   		<select class="form-control minutes" id="dataExportShoppingMinutes" style="width:115px; text-align-last:center;" v-model="minutes">
									<option>-</option>
									<option>직접입력</option>
						   		</select>
                        ...
                        <tr>
                           ...
                           <td class="direct">
						   		...
						   		<select class="form-control hours" id="dataExportShoppingHours" style="width:115px; text-align-last:center;" v-model="hours">
									<option>-</option>
									<option>직접입력</option>
						   		</select>
						   </td>
                        ...
                        <tr>
                           ...
                           <td class="direct">
						   		...
						   		<select class="form-control day" id="dataExportShoppingDay" style="width:115px; text-align-last:center;" v-model="day">
									<option>-</option>
									<option>직접입력</option>
						   		</select>
						   </td>
                        ...
                        <tr>
                           ...
                           <td class="direct">
						   		...
						   		<select class="form-control months" id="dataExportShoppingMonths" style="width:115px; text-align-last:center;" v-model="month">
									<option>-</option>
									<option>직접입력</option>
						   		</select>
						   </td>
                        ...
                        <tr>
                           ...
                           <td class="direct">
						   		...
						   		<select class="form-control year" id="dataExportShoppingYear" style="width:115px; text-align-last:center;" v-model="year">
									<option>-</option>
									<option>직접입력</option>
						   		</select>
						   </td>
                     ...
                     <table class="mg_auto ta_center" cellpadding="8" id="dataExportShoppingEach">
                        <tr>
                           <td class="fl"> 초 (Seconds):</td>
						   
						   <td>
						   		<select class="form-control" id="dataExportShoppingEachSeconds">
									<option>범위지정</option>
							  		<option>매초마다</option>
						   		</select>
						   </td>
                        ...
                        <tr>
						   ...
						   <td>
						   		<select class="form-control" id="dataExportShoppingEachMinutes">
									<option>범위지정</option>
							  		<option>매분마다</option>
						   		</select>
						   </td>
                        ...
                        <tr>
						   ...
						   <td>
						   		<select class="form-control" id="dataExportShoppingEachHours">
									<option>범위지정</option>
							  		<option>매시간마다</option>
						   		</select>
						   </td>
                        ...
                        <tr>
						   ...
						   <td>
						   		<select class="form-control" id="dataExportShoppingEachDay" >
									<option>범위지정</option>
							  		<option>매일마다</option>
						   		</select>
						   </td>
                        ...
                        <tr>
						   ...
						   <td>
						   		<select class="form-control" id="dataExportShoppingEachMonth" >
									<option>범위지정</option>
							  		<option>매월마다</option>
						   		</select>
						   </td>
...
<jsp:include page="/WEB-INF/view/admin/dataManage/script/dataExportRequestShoppingPopupScript.jsp"></jsp:include>
