	           		...
	           		<colgroup>
						...
						<col width="100px;" />
					     ...
					     <tr v-for="(list,index) in selectDatasetList">
	  						<td>{{dataSetList.records-(dataSetList.currentPage-1)*dataSetList.perPage-index}}</td>
						...
						<div class="buttons">
							<nav aria-label="pagination example" class="dis_in">
								<b-pagination ref="dataSetTable" for="table" align="center" size="md" :total-rows="dataSetList.records" v-model="dataSetList.currentPage" :per-page="dataSetList.perPage" limit="10"> </b-pagination>
							</nav>               
	            		</div>
