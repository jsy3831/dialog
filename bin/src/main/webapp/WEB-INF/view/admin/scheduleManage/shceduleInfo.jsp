<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div class="modal fade" id="schInfoPopup" tabindex="-1" role="dialog" aria-labelledby="examquestion_plusLabel" aria-hidden="true">
				...
				<div class="modal-body" >
					...
					<div class="wsize_50 fl pl_10 po_r bd_d table_sc17" id="style-3">
						<div class="wsize_97 hsize_01 po_r bd_d table_sc30" id="style-3">
							<table style="margin-top:15px" cellpadding="5">
								<tr style="padding:10px">
									<td class="table_tr_td_01">작업명 :</td><td><input type="text" style="width:200px" v-model="scheWorkTitle"></td>
								</tr>
								<tr style="padding:10px">
						...
						<div class="wsize_97 hsize_01 po_r bd_d table_sc32" id="style-3">
							<table style="margin: 75px 30px 40px 40px;" cellpadding="5" id="schInfo">
								<tr v-for="cron in scheCron">
									<td> Cron :</td><td><input type="text" style="width:220px" v-model="scheCron">{{cron.scheCron}}</td>
								</tr>
								<tr>
...
<jsp:include page="/WEB-INF/view/admin/scheduleManage/script/scheduleUpdatePopupScript.jsp"></jsp:include>		
